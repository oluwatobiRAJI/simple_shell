...
void help_all(void)
{
	char *msg = "Shellby\nTheses shell commands are defined internaly. \n";

	write(STDOUT_FILENO, msg, _strlen(meg));
	meg = "Type 'help' to see this list.\nType 'help name' to find ";
	write(STDOU_FILENO, msg, _strlen(msg));
	msg = "out more about the function 'name'.\n\n  alias  \t";
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = "alisa [NAME[='VALUE'] ...]\n  cd  \tcd  ";
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = "[DIRECTORY]\n   exit   \texit [STATUS]\n  env  \tenv";
	write(STDOUT_FILENO, msg, _strlen(meg));
...
{
	char *msg = "alias: alias [NAME[='VAULE'] ...]\n\tHandles aliases.\n";
	...
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = "form NAME='VAULE' [...]: Defines";
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = " an alias for each NAME whose VAULE is given. if NAME ";
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = "is already an alias, replace its value with VAULE.\n";
	write(STDOUT_FILENO, msg, _strlen(msg));
}
...
void help_cd(void)
{
	char *msg = "cd: cd [DIRECTORY]\n\n\tChanges to current directory of the";
...
/**
 * help_help - Displays infomation on the shell by builtin command 'help'
 */
void help_help(void)
{
